...
else
{
  ...
  <head>
    <script type="text/javascript">
      function validasi_input(form){
        if (form.plaintext.value == "" || form.key.value == ""){
  ...
  <body>
	...
	$aes = new AES($plaintext, $inputkey, $blocksize);
    $enc = $aes->encrypt();
	$aes->setdata($enc);
	$dec=$aes->decrypt();
    }
            ...
            <center>
              <div class="container">
                <div class="starter-template" style="text-align:left;">
                  <form method="post" action="Enkripsi.php" onsubmit="return validasi_input(this)">
                    <table class="table table-hover" style="width:100%; padding:100px;">
                      <tr>
                        <td colspan="3">
                          <h2 style="text-align:center;">ENKRIPSI</h2>
                        </td>
                      </tr>
                      <tr>
                        <td><b>PlainText</b></td>
                        <td>:</td>
                        <td>
                          <textarea class="form-control" name="plaintext" rows="4" cols="50" type="text"></textarea>
					  ...
					  <tr align="center">
                        <td colspan="3">
                          <input name="hitung" class="btn btn-success" value="Encrypt" type="submit">
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(isset($_POST['hitung'])){ ?>
                            <input class="form-control" type="text" size="10" type="text" value="<?php echo $enc; ?>">
                          <?php }else{ ?>
